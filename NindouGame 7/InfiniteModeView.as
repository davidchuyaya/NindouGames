package 
{
	...
	public class InfiniteModeView extends MovieClip
	{
		...
		*/
		...
		{
			//stick everything inside an array
			...
			//event listeners
			_pauseButton.addEventListener(TouchEvent.TOUCH_TAP, onPauseClick);
			//the accelerometer for detecting gravity shifts
			_accelerometer.addEventListener(AccelerometerEvent.UPDATE, onAcceleration);
			//reset the player
		...
		*/
		...
		private function pauseEverything():void
		{
			...
			//stop tilting from working
			_accelerometer.removeEventListener(AccelerometerEvent.UPDATE, onAcceleration);
		...
		*/
		...
		{
			//removeEventListener
			_pauseButton.removeEventListener(TouchEvent.TOUCH_TAP, onPauseClick);
			_accelerometer.removeEventListener(AccelerometerEvent.UPDATE, onAcceleration);
		...
		*/
		//accelerating
		private function onAcceleration(event:AccelerometerEvent):void
		{
			_controller.processAcceleration(event);
		}
		private function onPauseClick(event:TouchEvent):void
		{
